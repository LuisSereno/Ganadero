...
export class Detalle {
	...
	arrayDescendencia:Array<IEAnimal>;

	arrayAscendencia:Array<IEAnimal>;

	constructor(public navCtrl: NavController,  params: NavParams,public servicio: ServicioDatos,
				private toastCtrl: ToastService,private router: Router) {
	...
	protected modificaDatosAnimal(){
		...
		this.animal.metadatoEmail = this.servicio.getExplotacion().usuarios[0].id;
