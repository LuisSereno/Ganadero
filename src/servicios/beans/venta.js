...
var Venta = (function (_super) {
    ...
    **/
    ...
    Venta.prototype.toJSON = function () {
    ...
    Venta.fromJSON = function (json) {
        if (typeof json === 'string') {
            ...
            var mach = Object.create(Venta.prototype);
            /**            let jsonNuevo = {
    ...
    Venta.reviver = function (key, value) {
